 ...
 * Description:
 */
#ifndef HW_DISPLAY_CRTC_DRM_H
#define HW_DISPLAY_CRTC_DRM_H
...
class HwDisplayCrtcDrm : public HwDisplayCrtc {
public:
    HwDisplayCrtcDrm(int drvFd, int32_t id);
    ~HwDisplayCrtcDrm();
